...
const LETTERS = [
  ...
  { char: 'ך',  name: 'カフ・ソフィート',     romanized: 'Kaf sofit',     sound: 'kh' , hint: 'כの語尾形。縦棒が下に大きく伸びる。音は同じ。'},
  ...
  { char: 'ם',  name: 'メム・ソフィート',     romanized: 'Mem sofit',     sound: 'm'  , hint: 'מの語尾形。四角く完全に閉じる（通常形מは左下が少し開く）。'},
  { char: 'נ',  name: 'ヌン',                 romanized: 'Nun',           sound: 'n'  , hint: '起源は諸説。語尾ではןになり、縦棒が下に伸びる。'},
  { char: 'ן',  name: 'ヌン・ソフィート',     romanized: 'Nun sofit',     sound: 'n'  , hint: 'נの語尾形。縦棒が大きく下に伸びる（通常形נは短く丸い）。'},
  ...
  { char: 'ף',  name: 'ペー・ソフィート',     romanized: 'Pe sofit',      sound: 'f'  , hint: 'פの語尾形。縦棒が下に垂れる。音は同じ。'},
  { char: 'צ',  name: 'ツァデー',             romanized: 'Tsade',         sound: 'ṣ' , hint: '起源は諸説（釣り針など）。「正義（צֶדֶק）」の頭文字でもある。語尾はץ。'},
  { char: 'ץ',  name: 'ツァデー・ソフィート', romanized: 'Tsade sofit',   sound: 'ṣ' , hint: 'צの語尾形。縦画が下に長く伸びる。'},
...
// 379 syllables: consonant × vowel mark combinations (including begadkephat dagesh variants)
const SYLLABLES = [
